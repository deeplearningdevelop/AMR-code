...
from keras.layers import Input, Dense, Conv1D, MaxPool1D, ReLU, Dropout, Softmax, concatenate, Flatten, Reshape, \
    GaussianNoise,Activation,Conv2D
#from keras.layers.convolutional import Conv2D
from tensorflow.compat.v1.keras.layers import CuDNNLSTM,Lambda,Multiply,Add,Subtract,MaxPool2D,CuDNNGRU,LeakyReLU,BatchNormalization
import tensorflow as tf
